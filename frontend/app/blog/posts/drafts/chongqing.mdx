...
It's a functioning hospital, so this isn't a place to wander freely. That said, you can take the lift to the top floor for views over the Jiefangbei district that most visitors never find. The same trick that puts a metro through an apartment block puts a hospital entrance at a floor number that would mean something entirely different in any other city.
